...
public class OnePhaseStend extends StendDLLCommands{
    ...
    private List<String> stendModelList = Arrays.asList("HS3303", "HS6303");
    private List<String> refMetModelList = Arrays.asList("HY5101C-22", "HY5101C-23", "TC-3000B", "TC-3000C", "HC3801", "HC3101A", "HS5100H");
