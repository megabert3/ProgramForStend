...
public class StendCommands {
    ...
    public String stMeterRead() {
        ...
        stend.StdMeter_Read(SData, typeReferenceMeter, port);
        return SData;
    }
    ...
    public String meterErrorRead(int meterNo) {
        ...
        stend.Error_Read(MError, meterNo, port);
        return MError;
    }
    ...
    public boolean setPulseChannel(int meterNo, int channelFlag, int devPort) {
        return stend.Set_Pulse_Channel(meterNo, channelFlag, devPort);
    }
